		...
		$("#settingsPopupWindowDiv").jqxWindow({ theme: "metro", width: '33%', minWidth: 650, height: '70%', isModal: true, draggable: false, autoOpen: false, resizable: true, closeButtonSize: 0, initContent: function() {
			...
			const template = [
				...
				//GitHub-Issues options
				{
					...
					info: 'GitHub-Issue plugin - ONLY WITH CITY METAPHOR - requires credentials',
					padding: {left: 8, top: 0, bottom: 0, right: 8}
				},
				{
					type: 'blank',
				...
				},
				{
					...
					labelWidth: '325px',
					width: '200px',
					info: 'URL to GitHub repo of project',
					padding: {left: 8, top: 0, bottom: 0, right: 8}
				},
				{
					...
					labelWidth: '325px',
					width: '200px',
					info: 'User for retrieving GitHub-Issues using GitHub API',
					padding: {left: 8, top: 0, bottom: 0, right: 8}
				},
				{
					...
					labelWidth: '325px',
					width: '200px',
					info: 'password for retrieving GitHub-Issues using GitHub API',
					padding: {left: 8, top: 0, bottom: 0, right: 8}
				},
				{
					type: 'blank',
